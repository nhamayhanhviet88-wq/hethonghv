...
const _PAGE_SCRIPT_MAP = {
    ...
    'bophaninhv': '/js/pages/bophaninhv.js?v=20260722_sale_reminders_v1',
    'bophanin': '/js/pages/bophaninhv.js?v=20260722_sale_reminders_v1',
    'bo-phan-in': '/js/pages/bophaninhv.js?v=20260722_sale_reminders_v1',

...
const MENU_CONFIG = [
    ...
    { id: 'quanlykhovai', label: 'Quản Lý Kho Vải', icon: '🗺️', roles: ['giam_doc','quan_ly_cap_cao','quan_ly','truong_phong','nhan_vien','thu_viec','part_time'], section: 'XƯỞNG SẢN XUẤT', href: '/quanlykhovai', permKey: 'kho_vai' },

...
const MENU_CONFIG = [
    ...
    { id: 'quanlytkhethongaff', label: 'QL Hệ Thống Affiliate', icon: '📊', roles: ['giam_doc','quan_ly','quan_ly_cap_cao'], section: 'QUẢN LÝ AFFILIATE', href: '/quanlytkhethongaff', permKey: 'ql_he_thong_aff' },

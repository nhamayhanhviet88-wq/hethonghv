...
async function renderQuanlykhovaiPage(content) {
    ...
    if (!document.getElementById('qkvStyles')) {
        ...
        st.textContent = [
            ...
            '  background: linear-gradient(135deg, #7f1d1d, #b91c1c, #991b1b, #7f1d1d) !important;',
            '  background-size: 300% 300% !important;',
            '  animation: qkvShimmerGlow 5s ease infinite, qkvReturnPulse 3s infinite ease-in-out !important;',
            ...
            '.qkv-card-return-shelf .qkv-material-group-header { background: rgba(255, 255, 255, 0.15) !important; border: 1px solid rgba(255, 255, 255, 0.3) !important; color: #ffffff !important; }',
            '.qkv-card-return-shelf .qkv-material-group-header span { color: #ffffff !important; }',
            '.qkv-card-return-shelf .qkv-material-group-header div span { color: #fef08a !important; }',
            '.qkv-card-return-shelf .qkv-material-group-body { border-left: 2px dashed rgba(255, 255, 255, 0.4) !important; }',
            '.qkv-card-return-shelf .qkv-material-color-frame { background: rgba(255, 255, 255, 0.08) !important; border: 1px solid rgba(255, 255, 255, 0.2) !important; color: #ffffff !important; }',
            '.qkv-card-return-shelf .qkv-item-balance { color: #fef08a !important; }',
            '.qkv-card-return-shelf .roll-list-container { background: rgba(0, 0, 0, 0.25) !important; border: 1px solid rgba(255, 255, 255, 0.15) !important; }',
            '.qkv-card-return-shelf .roll-row-item { border-bottom: 1px solid rgba(255, 255, 255, 0.15) !important; }',
            '.qkv-card-return-shelf .roll-row-item span { color: #ffffff !important; }',
            '.qkv-card-return-shelf .roll-row-item a { color: #93c5fd !important; }',
            '.qkv-card-return-shelf .roll-row-item button.btn-outline-danger { color: #fca5a5 !important; border-color: #fca5a5 !important; }',
            '.qkv-card-return-shelf .roll-row-item button.btn-outline-danger:hover { background: #ef4444 !important; color: #ffffff !important; }',
            '@keyframes qkvReturnPulse {',
            '  0%, 100% { box-shadow: 0 4px 6px -1px rgba(0,0,0,0.01), 0 2px 4px -1px rgba(0,0,0,0.01); border-color: #fca5a5 !important; }',
            '  50% { box-shadow: 0 0 20px rgba(239, 68, 68, 0.8); border-color: #ffffff !important; }',
            '}',

...
const PERM_FEATURES = [
    ...
    { key: 'crm_nuoi_duong', label: 'CRM Gọi Điện Hợp Tác', perms: ['view','create','edit','delete'] },
    { key: 'crm_sinh_vien', label: 'CRM Gọi Điện Bán Hàng', perms: ['view','create','edit','delete'] },

...
const PERM_FEATURES = [
    ...
    { key: 'crm_hoa_hong', label: 'CRM Tự Tìm Kiếm', perms: ['view','create','edit','delete'] },
    { key: 'crm_goi_hop_tac', label: 'CRM Gọi Điện Hợp Tác', perms: ['view','create','edit','delete'] },
    { key: 'crm_goi_ban_hang', label: 'CRM Gọi Điện Bán Hàng', perms: ['view','create','edit','delete'] },

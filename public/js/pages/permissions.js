...
const PERM_FEATURES = [
    ...
    { key: 'crm_hoa_hong', label: 'CRM Giáo Viên/Học Sinh/Sinh Viên', perms: ['view','create','edit','delete'] },
    { key: 'crm_nuoi_duong', label: 'CRM Nhân Sự/Kế Toán/P.Mua Hàng', perms: ['view','create','edit','delete'] },
    { key: 'crm_sinh_vien', label: 'CRM Thể Thao/Thời Trang Local', perms: ['view','create','edit','delete'] },
    { key: 'affiliate_hv', label: 'Affiliate HV', perms: ['view'] },

...
async function _dhtShowDetail(id) {
    try {
        ...
        if (items.length > 0) {
            ...
            itemsHTML += `<div style="overflow:hidden;border-radius:8px;border:1px solid #e2e8f0"><table style="width:100%;border-collapse:collapse;font-size:12px;table-layout:fixed">`;

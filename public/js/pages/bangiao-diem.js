        ...
        sortedSlots.forEach((slot, idx) => {
            ...
            html += `<td style="padding:10px 14px;border-bottom:${borderB};background:#fafbfc;vertical-align:top;">
                <div style="background:linear-gradient(135deg,#122546,#1e3a5f);border-radius:10px;padding:10px 14px;text-align:center;box-shadow:0 2px 8px rgba(18,37,70,0.15);min-width:70px;">
                    ...
                    <div style="display:inline-block;background:linear-gradient(135deg,#f59e0b,#d97706);color:#fff;font-size:16px;font-weight:700;padding:2px 10px;border-radius:6px;margin-top:2px;letter-spacing:0.3px;text-shadow:0 1px 1px rgba(0,0,0,0.15);">${tEnd}</div>
                </div>
            </td>`;
            for (let d = 1; d <= 7; d++) {
                if (_tpHolidayMap[d]) {

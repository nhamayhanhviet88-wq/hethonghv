...
function _wtOpenForm(type){
    ...
    if(type==='order') h+='<div style="margin-bottom:12px"><label style="font-size:11px;font-weight:700;color:#374151;display:block;margin-bottom:4px">📦 Mã Đơn Hàng <span style="color:#dc2626">*</span></label><div style="position:relative"><input id="wtF_o" type="text" readonly placeholder="👆 Nhấn để tìm đơn hàng..." onclick="this.readOnly=false;this.value=\'\';this.placeholder=\'Nhập mã đơn để tìm...\';_wtSearchOrder(\'\')" oninput="_wtSearchOrder(this.value)" style="width:100%;padding:8px 10px;border:1px solid #d1d5db;border-radius:6px;font-size:12px;cursor:pointer;background:#f8fafc"><input type="hidden" id="wtF_oId"></div><div id="wtOrderResults"></div></div>';
    // Tiêu đề

...
function _prRenderToolbar() {
    ...
    tb.innerHTML = '<span class="pr-filter-info">📅 '+filterText+' <span class="pr-count">'+filtered.length+' mã</span></span>'
        ...
        + '<select id="prFilterClaim" style="padding:4px 10px;font-size:12px;border-radius:8px;border:1px solid #94a3b8;background:#f1f5f9;outline:none;cursor:pointer;font-weight:800;color:#0f172a;height:32px" onchange="_prChangeFilterClaim(this.value)">'
        ...
        + '</select>'
        + '<select id="prFilterSource" style="padding:4px 10px;font-size:12px;border-radius:8px;border:1px solid #94a3b8;background:#f1f5f9;outline:none;cursor:pointer;font-weight:800;color:#0f172a;height:32px" onchange="_prChangeFilterSource(this.value)">'

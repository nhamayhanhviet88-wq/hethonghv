...
function _prRenderTable() {
    ...
    pageRecords.forEach(function(r) {
        ...
        h += '<td style="font-weight:900;color:#d32f2f;text-align:right;padding-right:18px;font-size:12.5px">'+_prFmt(r.amount)+'</td>';
        h += '<td style="text-align:right;padding-right:28px">'+tienDuDisplay+'</td>';
        h += '<td>'+typeBadge+'</td>';

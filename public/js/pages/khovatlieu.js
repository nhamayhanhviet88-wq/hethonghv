...
function renderKhovatlieuPage(content) {
    if (!document.getElementById('_kvlStyle')) {
        ...
        st.textContent = 
            ...
            + '.kvl-stat-card.blue { background: linear-gradient(135deg, #0ea5e9, #0284c7); border-color: #0284c7; }'
            + '.kvl-stat-card.blue .label { color: rgba(255,255,255,0.85); }'
            + '.kvl-stat-card.blue .val { color: #ffffff; }'
            + '.kvl-stat-card.amber { background: linear-gradient(135deg, #f59e0b, #d97706); border-color: #d97706; }'
            + '.kvl-stat-card.amber .label { color: rgba(255,255,255,0.85); }'
            + '.kvl-stat-card.amber .val { color: #ffffff; }'
            + '.kvl-stat-card.emerald { background: linear-gradient(135deg, #10b981, #059669); border-color: #059669; }'
            + '.kvl-stat-card.emerald .label { color: rgba(255,255,255,0.85); }'
            + '.kvl-stat-card.emerald .val { color: #ffffff; }'
            ...
            + '.kvl-table th { background: #0f172a; padding: 10px 12px; color: #ffffff; font-weight: 700; text-transform: uppercase; font-size: 10px; border-bottom: 1px solid #1e293b; }'
            ...
            + '.kvl-modal-table th { background: #0f172a; padding: 8px 10px; color: #ffffff; font-weight: 700; border-bottom: 1px solid #1e293b; }'

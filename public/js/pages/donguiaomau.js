...
function _dgamRenderRows(paged) {
    ...
    tbody.innerHTML = paged.map(function(o) {
        ...
        var statusHtml = '<td style="text-align:center" onclick="event.stopPropagation()">'
            ...
            +'<span style="display:inline-block;padding:2px 8px;border-radius:4px;font-size:10px;font-weight:700;background:'+st.bg+';color:'+st.color+';margin:0 4px;white-space:nowrap;">'+st.label+'</span>'

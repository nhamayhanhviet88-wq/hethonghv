        ...
        const headersHtml = `
            <thead>
                <tr style="background: linear-gradient(135deg, #1e293b, #334155); color: white; font-size: 12px;">
                    ...
                    <th onclick="window._tkaCampSortBy('total_spend')" style="padding: 10px 8px; text-align: right; font-weight: 800; white-space: nowrap; cursor: pointer; user-select: none;" title="Bấm để lọc/sắp xếp theo Tổng Ngân Sách">TỔNG NGÂN SÁCH ${_getCampSortIcon('total_spend')}</th>
                    ...
                    <th onclick="window._tkaCampSortBy('total_run_count')" style="padding: 10px 8px; text-align: center; font-weight: 800; white-space: nowrap; cursor: pointer; user-select: none;" title="Bấm để lọc/sắp xếp theo Số lần chạy">SỐ LẦN CHẠY ${_getCampSortIcon('total_run_count')}</th>
                    <th onclick="window._tkaCampSortBy('filtered_run_count')" style="padding: 10px 8px; text-align: center; font-weight: 800; white-space: nowrap; cursor: pointer; user-select: none;" title="Số lần chạy hợp lệ (Đã loại trừ các ngày chạy dở < ${ignoreThreshLabel} không có tin nhắn)">SỐ LẦN CHẠY >${ignoreThreshK} ${_getCampSortIcon('filtered_run_count')}</th>
                    <th onclick="window._tkaCampSortBy('total_effective_count')" style="padding: 10px 8px; text-align: center; font-weight: 800; white-space: nowrap; cursor: pointer; user-select: none;" title="Bấm để lọc/sắp xếp theo Số lần hiệu quả">SỐ LẦN HIỆU QUẢ &lt;${threshK} ${_getCampSortIcon('total_effective_count')}</th>
                </tr>
            </thead>
        `;

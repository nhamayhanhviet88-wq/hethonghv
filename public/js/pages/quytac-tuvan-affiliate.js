        ...
        <div class="qt-flow-section" id="${sectionId}">
            <div class="qt-flow-header" onclick="_qtAToggleSection(this)">
                ...
                <div style="display:flex;align-items:center;gap:8px;">
                    ${_qtAIsGD ? `<button class="qt-flow-edit-btn" onclick="event.stopPropagation();_qtAShowEditRulesModal('${sec.key}')">✏️ Sửa</button><button class="qt-flow-edit-btn" style="background:#ef4444;padding:4px 8px;min-width:0;" onclick="event.stopPropagation();_qtADeleteSection('${sec.key}')" title="Xóa loại">🗑️</button>` : ''}

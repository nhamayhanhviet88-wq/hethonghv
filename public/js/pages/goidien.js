...
function _gd_renderSidebar() {
    ...
    // ★ Only show parent dept managers (QL/QLCC) when current user is GĐ/QLCC/QL — TP should NOT see their superiors
    const _canSeeManagers = ['giam_doc', 'quan_ly_cap_cao', 'quan_ly'].includes(currentUser.role);

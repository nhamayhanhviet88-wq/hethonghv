...
function _ktclRenderTable() {
    ...
    body.innerHTML = paginatedRecords.map((r, idx) => {
        if (r.production_cancelled) {
            ...
            return `
                <tr style="opacity:0.45; pointer-events:none; background:repeating-linear-gradient(45deg,transparent,transparent 10px,rgba(127,29,29,0.03) 10px,rgba(127,29,29,0.03) 20px);">

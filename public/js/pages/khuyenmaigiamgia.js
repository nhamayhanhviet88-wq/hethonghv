...
async function renderKhuyenMaiPage(container) {
    ...
    container.innerHTML = `
        <div style="padding: 24px; max-width: 1700px; margin: 0 auto; font-family: 'Inter', sans-serif;">
            <!-- Header Block -->
                    ...
                    <table style="width: 100%; border-collapse: collapse; text-align: left;">
                        <thead>
                            <tr style="background: #f8fafc; border-bottom: 1.5px solid #e5e7eb; color: #475569; font-weight: 700; font-size: 13px;">
                                ...
                                <th style="padding: 16px 24px; white-space: nowrap;">NHÂN VIÊN</th>
...
async function fetchAndRenderPromoCodes() {
    try {
        ...
        if (body) {
            body.innerHTML = `
                <tr>
                    <td colspan="12" style="text-align: center; padding: 40px; color: #ef4444; font-weight: 600;">

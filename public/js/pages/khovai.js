...
async function renderKhovaiPage(content) {
    if (!document.getElementById('kvStyles')) {
        ...
        st.textContent = [
            ...
            '.kv-stat-card.ton-kho-highlight{background:linear-gradient(135deg,#0d9488,#0f766e);color:#fff;border:1.5px solid #14b8a6;box-shadow:0 4px 12px rgba(13,148,136,0.35);min-width:110px;transform:scale(1.05);transition:all 0.3s}',
            '.kv-stat-card.ton-kho-highlight .kv-stat-label{color:#2dd4bf;font-weight:900}',
            '.kv-stat-card.ton-kho-highlight.negative{background:linear-gradient(135deg,#be123c,#9f1239);border-color:#fb7185;box-shadow:0 4px 12px rgba(190,18,60,0.35)}',
            '.kv-stat-card.ton-kho-highlight.negative .kv-stat-label{color:#fda4af}',

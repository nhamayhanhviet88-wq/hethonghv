...
async function _bnhLoadAll(){
    ...
    if(!window._bnhFabLoaded){window._bnhFabLoaded=true;var s=document.createElement('script');s.src='/js/pages/fab-import-v4.js?v=20260625_4';document.head.appendChild(s);}
    try{
...
function _bnhRender(){
    ...
    tb.innerHTML=all.map(function(r,i){
        ...
        +'<td style="text-align:right;font-weight:800;color:#1e293b;vertical-align:middle">'+_bnhFM(r.total_amount)+'</td>'
        +paidCellHtml

...
async function _bnhLoadAll(){
    ...
    if(!window._bnhFabLoaded){window._bnhFabLoaded=true;var s=document.createElement('script');s.src='/js/pages/fab-import-v4.js?v=20260601a';document.head.appendChild(s);}

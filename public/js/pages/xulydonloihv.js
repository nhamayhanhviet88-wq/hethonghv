    ...
    function _xldlRenderCardHTML(link, subId) {
        ...
        return `
            <div class="xldl-card-item theme-${themeName} ${link.isPinned ? 'is-pinned-card' : ''}">
                ...
                ${link.imageUrl ? `
                    <div style="position:relative; width:100%; height:140px; overflow:hidden; background:#f1f5f9; cursor:pointer;" onclick="window._xldlOpenDetailModal('${link.id}', '${subId}')" title="Click để xem chi tiết kịch bản & quy trình">

...
function _hdsdHeroHTML() {
    return '<section class="hdsd-hero" id="hdsd-hero">' +
        ...
        '<div class="hdsd-hero-content">' +
            ...
            '<p class="hdsd-hero-subtitle">Chỉ Cần Giới Thiệu Khách – HV Tư Vấn, Sản Xuất - Báo Cáo Tình Trạng Khách Mỗi Ngày - Trả Hoa Hồng Tự Động Sau Mỗi Đơn Hoàn Thành</p>' +

...
function _hdsdInitStickyBar() {
    ...
    bar.innerHTML = '<a class="hdsd-btn-gold hdsd-sticky-btn1" href="/chuyen-so" style="padding:10px 24px;font-size:13px;border-radius:10px;text-decoration:none">🚀 Chuyển Số Ngay</a>' +
        '<a class="hdsd-btn-sparkle hdsd-sticky-btn2" href="#" onclick="event.preventDefault();_hdsdScrollTo(\'hdsd-steps\');" style="padding:10px 24px;font-size:13px;border-radius:50px;text-decoration:none">✨ Cách Thức Hợp Tác</a>';

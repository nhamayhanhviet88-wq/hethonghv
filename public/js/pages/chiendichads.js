        ...
        <table style="width: 100%; border-collapse: collapse; min-width: 1400px;">
            <thead>
                <tr style="background: linear-gradient(135deg, #0f172a, #1e1b4b); border-bottom: 2px solid #334155;">
                    <th onclick="_cdAdsToggleSort('id')" style="padding:12px 10px;font-size:11.5px;font-weight:800;color:#ffffff;text-align:center;white-space:nowrap;letter-spacing:0.3px;cursor:pointer;user-select:none;" title="Sắp xếp theo STT / ID">STT ${_cdAdsSortIcon('id')}</th>
                    <th style="padding:12px 8px;font-size:11.5px;font-weight:800;color:#ffffff;text-align:center;white-space:nowrap;letter-spacing:0.3px;">ẢNH</th>
                    <th onclick="_cdAdsToggleSort('campaign_name')" style="padding:12px 10px;font-size:11.5px;font-weight:800;color:#ffffff;text-align:left;white-space:nowrap;letter-spacing:0.3px;cursor:pointer;user-select:none;" title="Sắp xếp theo Tên Chiến Dịch">TÊN CHIẾN DỊCH ${_cdAdsSortIcon('campaign_name')}</th>
                    <th onclick="_cdAdsToggleSort('channel_name')" style="padding:12px 8px;font-size:11.5px;font-weight:800;color:#ffffff;text-align:center;white-space:nowrap;letter-spacing:0.3px;cursor:pointer;user-select:none;" title="Sắp xếp theo Kênh / Tài Khoản">KÊNH ${_cdAdsSortIcon('channel_name')}</th>
                    <th onclick="_cdAdsToggleSort('post_id')" style="padding:12px 10px;font-size:11.5px;font-weight:800;color:#ffffff;text-align:center;white-space:nowrap;letter-spacing:0.3px;cursor:pointer;user-select:none;" title="Sắp xếp theo ID Post / ID Camp">ID POST / ID CAMP ${_cdAdsSortIcon('post_id')}</th>
                    <th onclick="_cdAdsToggleSort('total_spend')" style="padding:12px 10px;font-size:11.5px;font-weight:800;color:#ffffff;text-align:right;white-space:nowrap;letter-spacing:0.3px;cursor:pointer;user-select:none;" data-tooltip="Số tiền chi cho quảng cáo chiến dịch.">NGÂN SÁCH ${_cdAdsSortIcon('total_spend')}</th>
                    <th onclick="_cdAdsToggleSort('total_messages')" style="padding:12px 8px;font-size:11.5px;font-weight:800;color:#ffffff;text-align:center;white-space:nowrap;letter-spacing:0.3px;cursor:pointer;user-select:none;" data-tooltip="Số mess tin nhắn từ khách hàng.">TIN NHẮN ${_cdAdsSortIcon('total_messages')}</th>
                    <th onclick="_cdAdsToggleSort('avg_cpa')" style="padding:12px 8px;font-size:11.5px;font-weight:800;color:#ffffff;text-align:right;white-space:nowrap;letter-spacing:0.3px;cursor:pointer;user-select:none;" data-tooltip="Chi phí giá tiền / tin nhắn khách.">CPA ${_cdAdsSortIcon('avg_cpa')}</th>
                    <th onclick="_cdAdsToggleSort('avg_cpc')" style="padding:12px 8px;font-size:11.5px;font-weight:800;color:#ffffff;text-align:right;white-space:nowrap;letter-spacing:0.3px;cursor:pointer;user-select:none;" data-tooltip="Chi phí / mỗi lượt click vào quảng cáo.">CPC ${_cdAdsSortIcon('avg_cpc')}</th>
                    <th onclick="_cdAdsToggleSort('avg_ctr')" style="padding:12px 8px;font-size:11.5px;font-weight:800;color:#ffffff;text-align:center;white-space:nowrap;letter-spacing:0.3px;cursor:pointer;user-select:none;" data-tooltip="Tỷ lệ % nhấp vào quảng cáo.">CTR ${_cdAdsSortIcon('avg_ctr')}</th>
                    <th onclick="_cdAdsToggleSort('avg_cpm')" style="padding:12px 8px;font-size:11.5px;font-weight:800;color:#ffffff;text-align:right;white-space:nowrap;letter-spacing:0.3px;cursor:pointer;user-select:none;" data-tooltip="Chi phí cho 1.000 lượt hiển thị quảng cáo.">CPM ${_cdAdsSortIcon('avg_cpm')}</th>
                    <th onclick="_cdAdsToggleSort('total_run_count')" style="padding:12px 8px;font-size:11.5px;font-weight:800;color:#ffffff;text-align:center;white-space:nowrap;letter-spacing:0.3px;cursor:pointer;user-select:none;" data-tooltip="Số lần quảng cáo chạy mất tiền.">SL CHẠY TỔNG ${_cdAdsSortIcon('total_run_count')}</th>
                    <th onclick="_cdAdsToggleSort('run_count_gt70k')" style="padding:12px 8px;font-size:11.5px;font-weight:800;color:#ffffff;text-align:center;white-space:nowrap;letter-spacing:0.3px;cursor:pointer;user-select:none;" data-tooltip="Số lần chạy thực tế đạt ngưỡng chi tiêu.">SL CHẠY THỰC ${_cdAdsSortIcon('run_count_gt70k')}</th>
                    <th onclick="_cdAdsToggleSort('total_effective_count')" style="padding:12px 8px;font-size:11.5px;font-weight:800;color:#ffffff;text-align:center;white-space:nowrap;letter-spacing:0.3px;cursor:pointer;user-select:none;" data-tooltip="Số lần quảng cáo được đánh giá là đạt hiệu quả.">SL HIỆU QUẢ ${_cdAdsSortIcon('total_effective_count')}</th>
                    <th onclick="_cdAdsToggleSort('eff_rate')" style="padding:12px 8px;font-size:11.5px;font-weight:800;color:#ffffff;text-align:center;white-space:nowrap;letter-spacing:0.3px;cursor:pointer;user-select:none;" data-tooltip="Tỷ lệ % Hiệu Quả = (SL Hiệu Quả / SL Chạy Thực) * 100%">% HIỆU QUẢ ${_cdAdsSortIcon('eff_rate')}</th>
                    <th onclick="_cdAdsToggleSort('created_at')" style="padding:12px 10px;font-size:11.5px;font-weight:800;color:#ffffff;text-align:center;white-space:nowrap;letter-spacing:0.3px;cursor:pointer;user-select:none;" title="Sắp xếp theo Người Tạo / Ngày">NGƯỜI TẠO ${_cdAdsSortIcon('created_at')}</th>
                </tr>
            </thead>
            <tbody>${rows}</tbody>
        </table>

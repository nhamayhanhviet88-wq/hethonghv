...
+'.bpc-sb-total{background:#ffd1d1;color:#900000;border-left:5px solid #f87171;padding:12px 16px 12px 11px;font-size:13px;font-weight:800;display:flex;justify-content:space-between;align-items:center;cursor:pointer;position:relative;overflow:hidden;border-bottom:1px solid #ffd1d1;transition:all 0.2s}'
+'.bpc-sb-total:hover{background:#fca5a5}'
...
+'.bpc-sb-uncut{background:#ffdfb9;color:#aa3a00;border-left:5px solid #fb923c;padding:11px 16px 11px 11px;font-size:12px;font-weight:800;display:flex;justify-content:space-between;align-items:center;cursor:pointer;border-bottom:1px solid #ffdfb9;transition:all 0.2s}'
+'.bpc-sb-uncut:hover{background:#fdba74}'

...
const database = {
    ...
    async run(sql, params = []) {
        ...
        const noIdTables = ['app_config', 'task_schedule_active_teams', 'global_penalty_config', 'material_warehouse_sources', 'kv_order_consumed_slips', 'tsam_sample_products', 'meeting_session_departments', 'system_zalo_settings', 'ads_spend_limit_settings', 'ads_sync_schedule_settings'];

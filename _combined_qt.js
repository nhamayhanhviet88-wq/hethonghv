    ...
    let html = `
        <div class="qt-flow-section" id="${sectionId}">
            <div class="qt-flow-header" onclick="_qtCToggleSection(this)">
                ...
                <div style="display:flex;align-items:center;gap:8px;">
                    ${_qtCIsGD ? `<button class="qt-flow-edit-btn" onclick="event.stopPropagation();_qtCShowEditRulesModal('${sec.key}')">✏️ Sửa</button><button class="qt-flow-edit-btn" style="background:#ef4444;padding:4px 8px;min-width:0;" onclick="event.stopPropagation();_qtCDeleteSection('${sec.key}')" title="Xóa loại">🗑️</button>` : ''}
                    <span class="qt-flow-chevron">▼</span>
                </div>
            </div>
            <div class="qt-flow-body">
